  ...
  const photoSigns = [
    {
      ...
      category: "symptom",
      hint: "This abnormal growth is a reaction of the tree to Nectria canker, but Perithecia, the fruiting bodies of Nectria, are not visible.",
    },
    {
      term: "Chlorosis",
      image: "images/discoloration.jpeg",
      category: "symptom",
      hint: "This is discoloration of the leaf tissue. Yellowing is visibe on the left of the image, while other leaves are orange, red, or nectrotic.",
    },
    {
      term: "Emergence Holes",
      image: "images/emergence_hole.jpeg",
      category: "sign",
      hint: "This hole was physically created by an insect leaving the tree.",
    },
    {
      term: "Conk",
      image: "images/fungus.jpeg",
      category: "sign",
      hint: "The fungus is visible on the face cut of this log.",
    },
    {
      term: "Conk",
      image: "images/fungus_2.jpeg",
      category: "sign",
      hint: "These fruiting bodies are visible on the trunk of the tree.",
    },
    {
      term: "Gall",
      image: "images/gall_wasp.jpeg",
      category: "symptom",
      hint: "The image shows a gall (abnormal plant tissue) growing in response to the insect's presence. While the insect emergence hole is a sign, the gall is a response from the tree.",
    },
    {
      term: "Galleries",
      image: "images/galleries.jpeg",
      category: "sign",
      hint: "These galleries were carved directly by an insect.",
    },
    {
      term: "Gummosis",
      image: "images/gummosis.jpeg",
      category: "symptom",
      hint: "The image shows the tree's own resin or sap response; however, you may have seen the frass stuck to the resin. The frass is a sign, the resin is a symptom.",
    },
    {
      term: "Necrosis",
      image: "images/needle_death.jpeg",
      category: "symptom",
      hint: "This shows yellowing needles on both old and new growth. This is the plant's response to, in this case, an abiotic disorder.",
    },
    {
      term: "Rust",
      image: "images/rust.jpeg",
      category: "symptom",
      hint: "This swollen deformity is produced by the tree during the later-stages of a rust infection.",
    },
    {
      term: "Oozing",
      image: "images/slime_flux.jpeg",
      category: "symptom",
      hint: "This bleeding of sap from the cut stumps is the characteristic symptom of bacterial wetwood. Pathogens may contaminate the sap, resulting in the foul-smelling liquid that dries to light-coloured crust",
    },
  ];
